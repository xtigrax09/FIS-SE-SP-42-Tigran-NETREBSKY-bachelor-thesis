                ...
                <div className="row justify-content-center">
                  <div className="section-title">
                    ...
                    <p data-aos="fade-up" data-aos-delay="400">
                      {" "}
                      Що вас найбільше турбує або викликає запитання щодо нашого
                      веб-сайту?
                    </p>
                  </div>
                </div>
                <div className="row justify-content-center">
                  <div className="col-md-12">
                    <div className="wrapper">
                      ...
                      >
                        ...
                        <div className="col-md-3">
                          <div className="dbox w-100 text-center">
                            ...
                            <div className="text">
                              <p>
                                <span>Phone:</span>{" "}
                                <a href="tel://8980452333">+380 111111111</a>
                              </p>
                            </div>
                          </div>
                        </div>
                        <div className="col-md-3">
                          <div className="dbox w-100 text-center">
                            ...
                            <div className="text">
                              <p>
                                <span>Email:</span>{" "}
                                <a href="mailto:auction@gmail.com">
                                  auction@gmail.com
                                </a>
                              </p>
                            </div>
                        ...
                        <div className="col-md-3">
                          <div className="dbox w-100 text-center">
                            ...
                            <div className="text">
                              <p>
                                <span>Website</span> <a href="#">auction.com</a>
                              </p>
                            </div>
                          </div>
                        </div>
                      ...
                      <div
                        className="col-lg-10 mt-5 mt-lg-0  d-flex align-items-center justify-content-center contact"
                        data-aos="fade-up"
                        data-aos-delay="300"
                      >
                        <form
                        ...
                        >
                          ...
                          <div className="text-center">
                            <button type="submit" onClick={feedbackForm}>
                              Send Message
                            </button>
                          </div>
                        </form>
